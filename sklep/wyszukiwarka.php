...
<div class="row">
		<div class="offset-md-3 col-md-6 row">
			<div class="col-md-12"><h2>WYSZUKIWARKA</h2><br><h4>Wybierz kategorie produktu</h4></div>
				<div class="row">
					<div class="col-md-6">
						<div class="card m-1">
						  <div class="card-body">
						    <h5 class="card-title">Baterie</h5>
						    <h6 class="card-subtitle mb-2 text-muted">Tutaj znajdziesz wszystkie baterie</h6>
						    <p class="card-text">Dzieki nim zasilisz wszystkie swoje urzadzenia</p>
						    <a href="#" class="card-link">Znajdz baterie dla siebie</a>
						  </div>
						</div>							
					</div>
					<div class="col-md-6">
						<div class="card m-1">
						  <div class="card-body">
						    ...
						    <h6 class="card-subtitle mb-2 text-muted">Tutaj znajdziesz wszystkie czujniki</h6>
						    <p class="card-text">Rozpoznaj wieksza ilosc informacji dzieki czujnikom!</p>
						    <a href="#" class="card-link">Znajdz czujniki dla siebie</a>
						  </div>
						</div>						
					</div>
				</div>
					...
					<div class="col-md-6">
						<div class="card m-1">
						  <div class="card-body">
						    ...
						    <h6 class="card-subtitle mb-2 text-muted">Tutaj znajdziesz wszystkie diody</h6>
						    <p class="card-text">Potrzebuesz diody? Znajdziesz tutaj odpowiednia dla siebie!</p>
						    <a href="#" class="card-link">Znajdz diody dla siebie!</a>
						  </div>
						</div>						
					</div>
					<div class="col-md-6">
						<div class="card m-1">
						  <div class="card-body">
						    ...
						    <h6 class="card-subtitle mb-2 text-muted">Tutaj znajdziesz kondensatory</h6>
						    <p class="card-text">Potrzebujesz kondensatora? Znajdziesz tutaj odpowiednia dla siebie! </p>
						    <a href="#" class="card-link">Znajdz kondensatory dla siebie</a>
						  </div>
						</div>						
					</div>					
				</div>
